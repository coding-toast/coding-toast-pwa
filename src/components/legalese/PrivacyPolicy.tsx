...
const PrivacyPolicy: React.FC<PrivacyPolicyProps> = (props) => (
  <LegaleseDialog title="Privacy Policy" muted={props.muted}>
    <>
      ...
      <p>
        ...
        protect within commercially acceptable means to prevent loss and theft, as well as unauthorized access, disclosure, copying, use or
        modification.
      </p>
